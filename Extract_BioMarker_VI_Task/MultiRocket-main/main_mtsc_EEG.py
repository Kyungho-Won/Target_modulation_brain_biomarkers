...
if __name__ == '__main__':
    ...
    output_path = os.getcwd() + "/output_VS_20220529_" + str(num_class) + "cl/"
        ...
        for task in task_list:
            ...
            for sub in sub_str:
                ...
                if os.path.exists(data_folder):
                    ...
                    kfolder = StratifiedKFold(n_splits=k_fold, shuffle=True, random_state=seed)

                    for train_idx, test_idx in kfolder.split(temp_data, y=label):
                        X_train, X_test = temp_data[train_idx], temp_data[test_idx]
                        ...
                        sio.savemat(output_dir + sub + '_fold' + str(fold_iter) + '_classwise_classfied.mat', {'predicted_label':yhat_test, 'true_label':y_test})
                        ...
                        print(df_metrics)
                        if save:
                            df_metrics.to_csv(output_dir + sub + '_fold' + str(fold_iter) + '_classwise_results.csv', index=False)
